        ...
        return (
          <section key="hero" className="relative text-white py-4 md:py-8" style={{ backgroundColor: getBlockColor('hero', '#00447C') }}>
            ...
            <div className="relative max-w-[90%] md:max-w-4xl mx-auto px-4 text-center">
              <h1 className="font-bold mb-2 md:mb-3" style={{ fontFamily: `'${settings?.hero_title_font || 'Ubuntu'}', sans-serif`, fontSize: `clamp(18px, ${(settings?.hero_title_font_size || 36) * 0.67}px, ${settings?.hero_title_font_size || 36}px)` }}>{block.config.title || 'Encontrá tu próximo hogar'}</h1>
