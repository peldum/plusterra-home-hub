...
const sections: Section[] = [
  /* ━━━ ADMIN / SUPERADMIN / GERENTE ━━━ */
  {
    ...
    articles: [
      ...
      {
        id: 'admin-edificios',
        title: 'Gestión de edificios (actualizado)',
        description: 'Panel enriquecido con stats, ocupación, dueños y contratos por edificio.',
        icon: Building2,
        visibleTo: ADMIN_ROLES,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          '📊 NUEVO: Al entrar a "Edificios" ahora ves 4 tarjetas de resumen arriba: Total edificios, Unidades totales, % Ocupación global y Propietarios.',
          '📋 NUEVO: La vista principal cambió a una tabla profesional que muestra por cada edificio: unidades, ocupación (con barra de color), dueños vinculados, contratos activos y modelo de administración.',
          '🔴🟡🟢 La ocupación usa colores semáforo: Verde (80%+), Amarillo (50-79%), Rojo (menos de 50%).',
          '🔄 Podés cambiar entre vista Tabla (default) y vista Tarjetas con el toggle arriba a la derecha.',
          'Las tarjetas también muestran la barra de ocupación, dueños y contratos.',
          'Hacé clic en cualquier fila o tarjeta para entrar al detalle del edificio.',
          ...
          '💡 La información de dueños y contratos se calcula automáticamente desde las unidades y propiedades vinculadas. No hay que cargar nada extra.',
        ],
      },
      {
        id: 'admin-leads',
      ...
      {
        id: 'admin-registro-rapido',
        title: 'Registro Rápido de contratos ⚡',
        description: 'Nueva forma simplificada de cargar contratos en segundos, con soporte para propiedades externas.',
        icon: Zap,
        visibleTo: ADMIN_ROLES,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          'Andá a "Contratos" → botón "Nuevo Registro" → elegí "⚡ Registro Rápido".',
          'Es un formulario de una sola pantalla con los datos esenciales: tipo, propiedad, inquilino, fechas, monto y moneda.',
          '🔄 NUEVO: Toggle "Propiedad externa" — si la propiedad no está en el sistema, activá el switch y escribí la dirección a mano.',
          'Esto sirve para operaciones de co-brokerage o propiedades que no administramos.',
          'Si sos Admin o Secretaría, podés asignar el contrato a un agente específico.',
          'El botón "📄 Contrato Completo" sigue disponible para generar documentos legales con plantilla.',
          '💡 Recomendación: usá Registro Rápido para el 90% de los casos. Solo usá Contrato Completo cuando necesités imprimir el documento.',
          '📱 MEJORADO: El formulario ahora funciona perfecto en celular — los selectores no se desbordan.',
        ],
      },
      {
        id: 'admin-sidebar-agentes-limpio',
        title: 'Sidebar de agentes simplificado',
        description: 'Se removieron secciones innecesarias del menú lateral para agentes.',
        icon: Eye,
        visibleTo: ADMIN_ROLES,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          'Los agentes ya no ven "Propietarios" ni "Edificios" en su menú lateral.',
          'Antes les aparecían pero daba "Acceso denegado" o estaba vacío — generaba confusión.',
          'Ahora el menú del agente solo muestra lo que realmente puede usar.',
          'Los propietarios se gestionan desde el panel de Admin/Secretaría.',
        ],
      },
      {
        id: 'admin-pwa-sesion',
        title: 'PWA: sesión persistente',
        description: 'La app ya no redirige al login cada vez que se abre.',
        icon: Smartphone,
        visibleTo: ADMIN_ROLES,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          'Antes, al abrir la app desde el celular siempre iba a la pantalla de login.',
          'Ahora la app abre directamente en el Dashboard si ya hay sesión activa.',
          '⚠️ Los usuarios que ya tienen la app instalada necesitan reinstalarla (borrar y volver a agregar) para que tome el cambio.',
          'Nuevas instalaciones ya funcionan correctamente.',
        ],
      },
    ],
  },
  ...
  /* ━━━ AGENTES ━━━ */
  {
    ...
    articles: [
      ...
      {
        id: 'ag-registro-rapido',
        title: 'Registro Rápido de contratos ⚡',
        description: 'Cargá un contrato en segundos con el nuevo formulario simplificado.',
        icon: Zap,
        visibleTo: AGENT_ONLY,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          'Andá a "Contratos" → botón "Nuevo Registro" → elegí "⚡ Registro Rápido".',
          'Completá solo lo esencial: tipo, propiedad, inquilino, fechas y monto.',
          '🔄 NUEVO: Si la propiedad es externa (no está en el sistema), activá el toggle "Propiedad externa" y escribí la dirección.',
          'Esto es ideal para propiedades de co-brokerage o que no administramos.',
          '📱 El formulario funciona perfecto en celular — los selectores ya no se desbordan.',
          '💡 Usá "Registro Rápido" para el día a día. El "Contrato Completo" es para documentos legales con plantilla.',
        ],
      },
      {
        id: 'ag-menu-limpio',
        title: 'Menú simplificado',
        description: 'Tu menú lateral ahora muestra solo lo que necesitás.',
        icon: Eye,
        visibleTo: AGENT_ONLY,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          'Se removieron "Propietarios" y "Edificios" del menú lateral de agentes.',
          'Antes aparecían pero daban "Acceso denegado" o estaban vacíos.',
          'Ahora el menú muestra solo las secciones que realmente podés usar.',
          'La gestión de propietarios sigue disponible para Admin y Secretaría.',
        ],
      },
      {
        id: 'ag-pwa-sesion',
        title: 'La app ya no pide login cada vez',
        description: 'Ahora al abrir la app desde el celular mantiene tu sesión activa.',
        icon: Smartphone,
        visibleTo: AGENT_ONLY,
        esNuevo: true,
        fecha: '2026-03-18',
        steps: [
          'Antes, cada vez que abrías la app te llevaba a la pantalla de login.',
          'Ahora abre directamente en tu Dashboard si ya tenés sesión.',
          '⚠️ Si ya tenés la app instalada, necesitás reinstalarla: borrala del celular y volvé a agregarla.',
          'Las nuevas instalaciones ya funcionan bien.',
        ],
      },
    ],
  },
...
const universalGuides: Article[] = [
  {
    ...
    description: 'El paso a paso completo para cargar un contrato nuevo — ahora con dos opciones.',
    icon: FileText,
    visibleTo: ALL_ROLES,
    esNuevo: true,
    fecha: '2026-03-18',
    steps: [
      'Andá a "Contratos" → botón "Nuevo Registro".',
      'Tenés dos opciones: ⚡ "Registro Rápido" (recomendado) o 📄 "Contrato Completo".',
      '⚡ Registro Rápido: formulario de una pantalla con lo esencial. Ideal para el día a día.',
      '📄 Contrato Completo: wizard de 4 pasos con plantilla de documento legal.',
      'En ambos casos, si la propiedad NO está en el sistema: activá "Propiedad externa" y escribí la dirección.',
      'Si hay un captador externo (co-brokerage), registrá su nombre, inmobiliaria y teléfono en Contrato Completo.',
